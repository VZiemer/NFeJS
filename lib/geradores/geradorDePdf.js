...
//             normal(item.getIcms().getOrigem()+''+item.getIcms().getSituacaoTributaria(), 270, yDoItemAtual, 21, 'center', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);

//             normal(item.getIcms().getCfop(), 293.5, yDoItemAtual, 21, 'center', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);
...
//             normal(item.getIcms().getBaseDeCalculoDoIcmsFormatada(), 440, yDoItemAtual, 32.5, 'right', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);

//             normal(item.getIcms().getBaseDeCalculoDoIcmsFormatada(), 440, yDoItemAtual, 32.5, 'right', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);

//             normal(item.getIcms().getValorDoIcmsFormatado(), 474.5, yDoItemAtual, 32, 'right', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);

//             normal(item.getValorDoIpiFormatado(), 508.5, yDoItemAtual, 26, 'right', args.tamanhoDaFonteDosItens, pdf);
//             maiorY = Math.max(maiorY, pdf.y);

//             normal(item.getIcms().getAliquotaDoIcmsFormatada(), 536, yDoItemAtual + 0.65, 19, 'center', args.tamanhoDaFonteDosItens - 1, pdf);
//             maiorY = Math.max(maiorY, pdf.y);
