...
var Icms = (function () {
    ...
    Icms.prototype.CalculaIcms = function (_prodSt, _regTrib, _ufOri, _ufDest, _destContrib, _cFinal, _baseDeCalculoDoIcms, _aliquotaDoIcms, _prodOrigem) {
        ...
        if (_regTrib === "1") {
            ...
            if (_ufOri === _ufDest) {
                ...
                this._baseDeCalculoDoIcms = 0;
                this._valorDoIcms = 0;
                this._aliquotaDoIcmsSt = 0;
                this._baseDeCalculoDoIcmsSt = 0 ;
                this._valorDoIcmsSt = 0 ;                   
            }
        }
        if (_regTrib === "2" || _regTrib === "3") {
            ...
            if (_ufOri === _ufDest) {
                ...
                this._aliquotaDoIcmsSt = _prodSt ? _aliquotaDoIcms : "";
                this._baseDeCalculoDoIcmsSt = _prodSt ? _baseDeCalculoDoIcms : "" ;
                this._valorDoIcmsSt = _prodSt ? _baseDeCalculoDoIcms * _aliquotaDoIcms / 100 : "" ;                
            }
        }
    ...
    Icms.prototype.getBaseDeCalculoDoIcmsSt = function () {
        //Embora os valores daqui para baixo sejam numéricos
        //eu deixei retornando string vazio por padrão
        return this._baseDeCalculoDoIcmsSt || '';
    };
