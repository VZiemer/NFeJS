...
var Icms = (function () {
    ...
    Icms.prototype.CalculaIcms = function (_prodSt, _regTrib, _ufOri, _ufDest, _destContrib, _cFinal, _baseDeCalculoDoIcms, _aliquotaDoIcms, _prodOrigem, _operacao, _aliqCredSN) {
        ...
        if (_regTrib === "1") {
            ...
            if (_operacao == 1) {
                ...
                if (_ufOri === _ufDest) {
                    ...
                    this._aliquotaCredICMSSN = this._CodSituacaoTributaria === "101" ? _aliqCredSN : 0;
                    this._valorCredICMSSN = this._CodSituacaoTributaria === "101" ? new Dinheiro(_baseDeCalculoDoIcms * _aliqCredSN / 100) : 0;
                }
                if (_ufOri !== _ufDest) {
            ...
            if (_operacao == 1) {
                ...
                if (_ufOri === _ufDest) {
                    ...
                    if (_destContrib === 9) { //grupo somente no caso de não contribuinte
                        this._pICMSUFDest = tabelaicms[_ufDest][_ufDest];
                        this._pICMSInter = (_prodOrigem == 2 || _prodOrigem == 3) ? 4 : tabelaicms[_ufOri][_ufDest];
                        this._vBCUFDest = _prodSt ? "" : new Dinheiro(_baseDeCalculoDoIcms);
                        this._pICMSInterPart = 100;
                        this._vICMSUFDest = new Dinheiro ( _prodSt ? 0 : new Dinheiro(_baseDeCalculoDoIcms * this._pICMSInter / 100) ); //
                        this._vICMSUFRemet = new Dinheiro(0);
                        this._pFCPUFDest = tabelaicms[_ufDest].FCP;
                        this._vFCPUFDest = new Dinheiro ( _prodSt ? 0 : new Dinheiro(_baseDeCalculoDoIcms * this._pFCPUFDest / 100) );
                        this._vBCFCPUFDest = _prodSt ? "" : new Dinheiro(_baseDeCalculoDoIcms);;
                    }
            ...
            if (_operacao == 3) {
                ...
                if (_ufOri !== _ufDest) {
                    ...
                    this._CodSituacaoTributaria = _prodSt ? "60" : "00";
                    this._Cfop = "6202";
                    this._aliquotaDoIcms = _prodSt ? "" : 4;
                    this._baseDeCalculoDoIcms = _prodSt ? "" : new Dinheiro(_baseDeCalculoDoIcms);
                    this._valorDoIcms = _prodSt ? 0 : new Dinheiro(_baseDeCalculoDoIcms * 4 / 100);
                    this._aliquotaDoIcmsSt = _prodSt ? _aliquotaDoIcms : 0;
                    this._baseDeCalculoDoIcmsSt = _prodSt ? new Dinheiro(0) : new Dinheiro(0);
                    this._valorDoIcmsSt = _prodSt ? new Dinheiro(0) : new Dinheiro(0);
                    console.log(this)
    ...
    Icms.prototype.getAliquotaCredICMSSN = function () {
        return this._aliquotaCredICMSSN || '';
    }
    Icms.prototype.getvalorCredICMSSN = function () {
        return this._valorCredICMSSN || 0;
    }
