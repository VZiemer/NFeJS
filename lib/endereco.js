...
var Endereco = (function() {
    ...
    Endereco.prototype.getCodMunicipio = function() {
        return this._codmun;
    };

    Endereco.prototype.comCodMunicipio = function(_codmun) {
        this._codmun =_codmun;
        if(_codmun) {
            this._codpais = 1058;
            this._pais = 'Brasil';
        }
    ...
    Endereco.prototype.getCodPais = function() {
